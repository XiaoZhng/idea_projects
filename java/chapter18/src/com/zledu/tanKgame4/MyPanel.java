...
public class MyPanel extends JPanel implements KeyListener, Runnable{
    ...
    public MyPanel(){
        ...
        //初始化图片对象
        image1 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/bow1.jpg"));
        image1 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/bow2.jpg"));
        image1 = Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/bow3.jpg"));
    }
